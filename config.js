...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || 'Isis',
    ...
    BOT_INFO: process.env.BOT_INFO || 'Isis;KIDD JUICE;263779694908;https://i.imgur.com/6oRG106.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'Isis;KIDDJUICE;https://i.imgur.com/fj2WE83.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'Isis;KIDDJUICE' : process.env.STICKER_DATA,
